...
export function Header() {
  return (
    <header className="w-full py-2 px-2 flex items-center justify-center bg-gray-700 border-b border-gray-600 font-semibold">
       <nav className="w-full px-2 bg-white border-gray-200 dark:bg-transparent dark:border-transparent">
            ...
            <ul className="flex flex-col p-4 mt-4 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0   dark:border-gray-700">
              ...
              <li>
                ...
                {/* <div
                  ...
                  // style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(381px, 66px);"
                >
                  <ul
